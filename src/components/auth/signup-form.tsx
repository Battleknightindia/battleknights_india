...
import { signInWithOAuth } from "@/lib/actions/auth_actions";
        ...
        <Card className="w-full max-w-md bg-zinc-900/50 backdrop-blur-xl border-zinc-800 shadow-2xl relative z-10">
            ...
            <CardContent className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <Button variant="outline" className="w-full border-zinc-700 bg-zinc-800/50 text-zinc-200 hover:bg-zinc-800 hover:text-white hover:border-zinc-600 transition-all h-11" onClick={() => signInWithOAuth('google')}>
                        {/* Google Icon SVG */}
                    ...
                    <Button variant="outline" className="w-full border-zinc-700 bg-zinc-800/50 text-zinc-200 hover:bg-zinc-800 hover:text-white hover:border-zinc-600 transition-all h-11" onClick={() => signInWithOAuth('discord')}>
                        {/* Discord Icon SVG */}
            ...
            <CardFooter className="flex flex-col space-y-4 text-center pb-8">
                <div className="text-sm text-zinc-400">
                    ...
                    <Link href="/auth/login" className="text-emerald-500 font-bold hover:text-emerald-400 hover:underline transition-colors">
                        Sign in
                    </Link>
                </div>
            </CardFooter>
