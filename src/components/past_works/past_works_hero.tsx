...
export default function PastWorksHero() {
    return (
        <section className="relative h-screen min-h-[85vh] flex items-center justify-center overflow-hidden bg-black">
            {/* Ambient Background - Gold/Amber for "Legacy/History" */}
            {/* <div className="absolute inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-0 left-1/4 w-[600px] h-[600px] bg-emerald-500/10 rounded-full blur-[120px] mix-blend-screen animate-pulse" />
                <div className="absolute bottom-0 right-1/4 w-[600px] h-[600px] bg-blue-500/10 rounded-full blur-[120px] mix-blend-screen animation-delay-2000" /> */}
            ...
            <div className="container mx-auto px-4 lg:px-6 relative z-10 text-center">
                ...
                >
                    ...
                    <h1 className="text-5xl md:text-7xl lg:text-9xl font-black text-white tracking-tighter leading-[0.9]">
                        OUR <br />
                        <span className="text-transparent bg-clip-text bg-linear-to-r from-emerald-400 via-emerald-200 to-blue-500 mt-2">
                            LEGACY
                        </span>
                    </h1>

                    <p className="text-lg md:text-2xl text-zinc-400 max-w-3xl mx-auto leading-relaxed font-light">
                        History is written by the victors. From regional skirmishes to <span className="text-zinc-100 font-medium">National Showdowns</span>, witness the timeline of excellence.
                    </p>
                </motion.div>
            </div>
            ...
            >
                <span className="text-[10px] uppercase tracking-[0.2em]">Explore Timeline</span>
                <motion.div
                    animate={{ y: [0, 5, 0] }}
